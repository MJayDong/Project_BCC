...
**Overview**
This repository contains the full computational workflow, scripts, visualization code, and processed data objects for our study profiling the single-cell transcriptomic (scRNA-seq) and chromatin accessibility (scATAC-seq) landscapes of Basal Cell Carcinoma (BCC) patients before and after anti–PD-1 immunotherapy.
The analysis integrates cell states, regulatory programs, trajectory remodeling, and chromatin–gene regulatory networks, revealing how PD-1 blockade reshapes the tumor microenvironment and reactivates anti-tumor immunity.
This repository is designed to be fully reproducible, modular, and extensible, enabling other researchers to apply the pipeline to their own datasets.
